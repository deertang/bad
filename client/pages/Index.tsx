...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-tinytype-cream via-background to-tinytype-yellow-light">
      {/* Header */}
      <header
        className="sticky top-0 z-50 backdrop-blur-md border-b border-tinytype-yellow/20"
        style={{ backgroundColor: "rgba(255, 255, 245, 0.8)" }}
      >
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center">
              <h1 className="font-bold text-tinytype-brown text-lg">
                排版小动物
              </h1>
            </div>
          </div>
      ...
      <section
        ...
        style={{ backgroundColor: "rgb(255, 250, 196)" }}
      >
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg text-tinytype-brown/60 mb-12 max-w-2xl mx-auto"></p>
        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-6 items-start">
            <div>
              ...
              <p className="text-lg text-tinytype-brown/70 mb-8"></p>
              <ul className="space-y-4">
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-tinytype-yellow rounded-full mr-3"></div>
                  <span className="text-tinytype-brown/80 text-xl leading-relaxed">
                    全世界各地的小动物，带来有他们温度和风格模板
                  </span>
                </li>
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-tinytype-yellow rounded-full mr-3"></div>
      ...
      <footer
        id="contact"
        className="text-white px-4 pb-16"
        style={{ backgroundColor: "rgb(255, 250, 196)" }}
      >
        <div className="container mx-auto">
          <div className="border-t border-tinytype-brown/20 pt-8 text-center text-sm text-tinytype-brown/60 space-y-2">
            <div className="flex flex-wrap justify-center gap-6 mb-4">
              <a
                href="http://tinytypezoo.com/terms-of-service"
                className="hover:text-tinytype-yellow-dark transition-colors"
              >
                用户协议
              </a>
              <span>|</span>
              <a
                href="http://tinytypezoo.com/privacy-policy"
                className="hover:text-tinytype-yellow-dark transition-colors"
              >
                隐私政策
              </a>
