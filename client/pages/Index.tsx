      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="#download" 
              className="inline-flex items-center justify-center px-8 py-4 bg-tinytype-yellow hover:bg-tinytype-yellow-dark text-tinytype-brown font-semibold rounded-2xl transition-all transform hover:scale-105 shadow-lg"
            >
